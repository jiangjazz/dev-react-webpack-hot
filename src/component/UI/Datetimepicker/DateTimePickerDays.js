  ...
  render() {
    ...
    <div className="datepicker-days" style={{display: "block"}}>
        <table className="table-condensed">
          <thead>
            <tr>
              <th className="prev" onClick={this.props.subtractMonth}><i className="iconfont icon-long-icon-arrow-left" /></th>
              ...
              <th className="next" onClick={this.props.addMonth}><span className="iconfont icon-long-icon-arrow-right" /></th>
            </tr>
