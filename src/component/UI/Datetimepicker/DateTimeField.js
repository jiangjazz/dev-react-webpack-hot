  ...
  onClick = () => {
    ...
    if (this.state.showPicker) {
      ...
      if (placePosition === "top") {
        ...
        classes["bootstrap-pull-right"] = true;
      } else {
        offset.top = 40;
        classes.top = false;
        classes.bottom = true;
    ...
    return (
          <div>
            ...
            <DateTimePicker
                  ...
                  setSelectedToday={this.setSelectedToday}
            ...
            />
            <div className={"m-input__group m-input--IconRight u-input__datepick__box" + this.size()} ref="datetimepicker">
              <input className="u-input u-input__datepick" onChange={this.onChange} type="text" value={this.state.inputValue} {...this.props.inputProps}/>
              <i className="iconfont icon-calendar" onBlur={this.onBlur} onClick={this.onClick} ref="dtpbutton"></i>
